<%@ Page Title="" Language="C#" MasterPageFile="~/MenuMstr.Master" AutoEventWireup="true" CodeBehind="PR_View.aspx.cs" Inherits="ERP_System.PR_Module.Forms.PR_View" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel13" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">PR View</h1>
                </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <%--<div class="form-group">
                                          ...
                                          <!-- /department -->
                                                <div class="form-group">
                                                    <label for="disabledSelect">Requestor Department</label>
                                                 <%--   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                        <ContentTemplate>--%>
                                                            <asp:DropDownList ID="ddlr_dpt" runat="server" CssClass="form-control deptMain">
                                                            </asp:DropDownList>
                                                       <%-- </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="btnsave" />
                                ...
                                <ul class="nav nav-pills">
                                    <li class="active"><a href="#Header" data-toggle="tab">User PR List</a>
                                    </li>
                                                            ...
                                                            <ContentTemplate>
                                                                <asp:GridView ID="dgvheader" runat="server" CssClass="table table-striped table-bordered table-hover" Width="100%" AutoGenerateColumns="False" AllowPaging="true" PageSize="20" OnPageIndexChanging="dgvheader_PageIndexChanging">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="verify_nm" HeaderText="Certified By" NullDisplayText="-"></asp:BoundField>
                                                                        <asp:BoundField DataField="verify_dt" HeaderText="Certified Date" NullDisplayText="-"></asp:BoundField>
                                                                        <asp:BoundField DataField="approve_nm" HeaderText="Approved By" NullDisplayText="-"></asp:BoundField>
