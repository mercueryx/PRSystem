<%@ Page Title="" Language="C#" MasterPageFile="~/MenuMstr.Master" AutoEventWireup="true" CodeBehind="PR_APPROVAL.aspx.cs" Inherits="ERP_System.PR_Module.Forms.PR_APPROVAL" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel13" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">PR APPROVAL</h1>
                </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <ul class="nav nav-pills">
                                    <li class="active"><a href="#Header" data-toggle="tab">Certified PR</a>
                                    </li>
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:DropDownList ID="ddlall" runat="server" OnSelectedIndexChanged="ddlall_SelectedIndexChanged" AutoPostBack="true">
                                                                                        ...
                                                                                        <asp:ListItem Value="APPROVED">APPROVE ALL</asp:ListItem>
                                                                ...
                                                                <ContentTemplate>
                                                                    <asp:GridView ID="dgvheader" runat="server" CssClass="table table-striped table-bordered table-hover" Width="100%" AutoGenerateColumns="False" AllowPaging ="true" PageSize="20" OnPageIndexChanging="dgvheader_PageIndexChanging">
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField DataField="verify_by" HeaderText="Verified By"></asp:BoundField>
                                                                            <asp:BoundField DataField="verify_dt" HeaderText="Verified Date"></asp:BoundField>
                                                                        </Columns>
